...
def get_default_config():
    ...
    cfg.model.load_weights = '/root/autodl-tmp/bpbreid_occluded_duke_hrnet32_10670.pth'  # path to model weights, for doing inference with a model that was saved on disk with 'save_model_flag'
    ...
    cfg.model.bpbreid.hrnet_pretrained_path = "/mnt3/qhb/model/" # path to pretrained weights for HRNet backbone, download on our Google Drive or on https://github.com/HRNet/HRNet-Image-Classification
